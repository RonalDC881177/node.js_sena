...
exports.getSubcategories = async (req, res) => {
  try {
    ...
    const subcategories = await Subcategory.find(activeFilter).populate(
      "category",
      "name",
    );
    res.status(200).json({
...
exports.updateSubcategory = async (req, res) => {
  try {
    ...
    if (req.body.description !== undefined) {
      subcategory.description = req.body.description.trim();
    }
  ...
  try {
    ...
    if (isHardDelete) {
      ...
      res.status(200).json({
        success: true,
        message:
          "Subcategoria eliminada permanentemente y sus productos relacionados",
        data: {
      ...
      return res.status(200).json({
        success: true,
        message:
          "Subcategoria desactivada exitosamente como sus productos asociados",
        data: {
          subcategory: subcategory,
