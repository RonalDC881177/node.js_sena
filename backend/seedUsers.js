  ...
  const users = [ // Array con los datos de los usuarios de ejemplo a crear
    {
      ...
      password: 'admin123456',          // Contraseña en texto plano; el pre-save hook del modelo la encriptará automáticamente
    ...
    },
    {
      ...
      password: 'coord123456',          // Contraseña en texto plano; será encriptada por el pre-save hook
